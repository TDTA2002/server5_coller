...
import { PayMode, Receipt, ReceiptStatus } from "../receipts/entities/receipt.entity";
...
export class GuestService {
  ...
  async create(receiptDetails: ReceiptDetailDto[], guest: GuestDto, payMode: string, total: number) {
    /* Tạo guest */
    console.log("gues2211t", guest);
    console.log(", payMode, total", payMode);
    ...
    try {
      ...
      console.log("guestExisted", guestExisted);
